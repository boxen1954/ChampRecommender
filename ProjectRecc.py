...
apiKey = "RGAPI-5381d0a9-53d3-415d-93a2-ebbba19fabe9"
...
def getInfo():
    ...
    print()
    gameID = recentMatches["matches"][0]["gameId"]
    ...
    champURL = "https://na1.api.riotgames.com/lol/static-data/v3/champions/" + str( recentMatches["matches"][0]["champion"] ) + "?locale=en_US&champData=tags&api_key=" + apiKey
